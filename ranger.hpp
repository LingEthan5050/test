...
class Ranger : public Character {
  ...
  */
    Ranger(const  string& name, const  string& race, int vitality = 0, int armor = 0, int level = 0, bool enemy = false,  vector<Arrows> arrows = {},  vector< string> affinities = {}, bool has_companion = false);
  /**
  ...
  **/
    bool addAffinity(const  string& affinities);
  /**
