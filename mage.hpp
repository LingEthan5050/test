...
*/
    Mage(const  string& name, const  string& race, int vitality = 0, int armor = 0, int level = 0, bool enemy = false, const  string& school_of_magic = "NONE", const  string& weapon = "NONE", bool can_summon_incarnate = false);
/*
...
**/
  ...
  private:
     string school_of_magic_, weapon_; //A string that represents their school of magic
